module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
    	...
    	dist: {
	    	files: {
	    		'html/dist/cubesviewer.css': 'cubesviewer/cubesviewer.less'
	    	}
    	}
    },
    uglify: {
      ...
      dist: {
        files: {
          'html/dist/<%= pkg.name %>.min.js': ['<%= concat.dist.dest %>']
        }
      }
    },
    copy: {
      	dist: {
    		files: [
    		    { expand: true, cwd: 'html/dist', src: '*', dest: '../cubesviewer-page/lib/cubesviewer/' },
    		    { expand: true, cwd: 'html/dist', src: '*', dest: '../cubesviewer-server/cvapp/cubesviewer/static/lib/cubesviewer/' }
	        ]
    	}
    },
    qunit: {
